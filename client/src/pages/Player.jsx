...
export default function Player() {
  ...
  // ── Loop RAF — atualiza currentTime e activeLine com máxima precisão ──────
  ...
  useEffect(() => {
    ...
    const onEnd   = () => { setPlaying(false); stopRaf(); setActiveLine(-1); activeRef.current = -1; };
    const onSeek  = () => { if (!audio.paused) startRaf(); };
  ...
  // Se for vídeo, redireciona para VideoPlayer
      ...
      <div className="container" style={{ padding: '20px 16px 80px' }}>
        ...
        {lyrics.length > 0 ? (
          <div className="fade-up">
            ...
            {/* Container de letras com scroll */}
            <div
              ref={lyricsRef}
              style={{
              ...
              {lyrics.map((line, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: '10px 18px', marginBottom: 2, borderRadius: 10,
                      cursor: 'pointer',
                      // Transição suave em todas as propriedades visuais
                      transition: 'background 0.3s, border-left-color 0.3s, transform 0.3s, color 0.3s, font-size 0.3s, font-weight 0.3s, opacity 0.3s, box-shadow 0.3s',
                  ...
                  >
                    ...
                    {isActive && (
                      <span style={{
                        ...
                        background: 'var(--gold)', marginLeft: 9,
                        verticalAlign: 'middle', animation: 'lyrPulse 1s ease-in-out infinite',
                      }} />
                    )}
                  </div>
                );
